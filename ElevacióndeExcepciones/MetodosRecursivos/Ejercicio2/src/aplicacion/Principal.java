...
public class Principal{
    public static void main(String[] args){
        ...
        System.out.println("La suma de los n numeros dados es: " + suma.sumaEnteroPositivos(5));
        ...
        System.out.println("La suma de los n elementos pares es " + SumaPares.sumaPares(5));
        ...
        System.out.println("La secuencia fibonacci para un numero n dado es: " + FibonacciRecursivo.secuenciaFibonacci(9));
